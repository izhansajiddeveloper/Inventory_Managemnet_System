    ...
    <div class="form-card">
        ...
        <div class="form-body">
            ...
            <form method="POST" id="editUserForm">
                <!-- User Info Preview -->
                <div class="d-flex align-items-center gap-3 p-3 bg-light rounded-3 mb-4" style="background: #f8fafc;">
                    <div class="user-avatar">
                        <?= strtoupper(substr($user['name'], 0, 1)) ?>
                    </div>
                    <div>
                        <div class="fw-bold text-slate-900"><?= htmlspecialchars($user['name']) ?></div>
                        <div class="small text-slate-500">Member since <?= date('M d, Y', strtotime($user['created_at'])) ?></div>
                    </div>
                </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-requirement">
                                <i class="fa-regular fa-circle-info"></i>
                                Only enter if you want to change the password (min. 3 chars)
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="role_id" class="form-control" required>
                                    <?php foreach ($roles as $role): ?>
                                        ...
                                        $icon = $role_icons_display[$role['name']] ?? '•';
                                        ?>
